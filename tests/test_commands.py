...
from valecode.commands.parser import complete, parse_command
from valecode.commands.registry import (
    Command,
    CommandContext,
    CommandRegistry,
    CommandType,
...
class TestHelpHandler:
    ...
    async def test_list_all(self) -> None:
        ...
        from valecode.commands.handlers.help import handle_help
...
class TestPlanDoHandlers:
    ...
    async def test_plan_switches_mode(self) -> None:
        from valecode.commands.handlers.plan import handle_plan
...
class TestSkillHandler:
    ...
    async def test_skill_list_no_loader(self) -> None:
        from valecode.commands.handlers.skill import handle_skill
...
class TestStatusHandler:
    ...
    async def test_status_output(self) -> None:
        from valecode.commands.handlers.status import handle_status
...
class TestMemoryHandler:
    ...
    async def test_memory_display(self) -> None:
        from valecode.commands.handlers.memory import handle_memory
