...
from valecode.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from valecode.agents.fork import (
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".valecode" / "agents"
...
class TestPermissionMode:
    def test_bypass_mode(self):
        from valecode.permissions.modes import PermissionMode, mode_decide
