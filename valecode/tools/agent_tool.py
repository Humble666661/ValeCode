...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from valecode.agents.fork import ForkError, build_forked_messages
        from valecode.agents.parser import AgentDef
        from valecode.agents.tool_filter import clone_registry_for_fork, resolve_agent_tools
        ...
        if p.subagent_type is None:
            from valecode.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from valecode.teams.models import BackendType, TeammateInfo
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from valecode.worktree.integration import (
